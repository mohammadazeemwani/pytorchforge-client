 ...
 */
export function ConvTranspose1dSection({
  className,
  form,
  ...delegated
  ...
  const { error } = form.getFieldState("customModelsData.ConvTranspose1d", form.formState)

  const resetSection = React.useCallback(() => {
    form.resetField("customModelsData.ConvTranspose1d")
    setResetKey(k => k+1)
  }, [form])
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-0">Params of ConvTranspose1d</DialogTitle>
