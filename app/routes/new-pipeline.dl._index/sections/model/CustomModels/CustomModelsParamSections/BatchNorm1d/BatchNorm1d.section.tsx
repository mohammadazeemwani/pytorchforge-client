 ...
 */
export function BatchNorm1dSection({
  className,
  form,
  ...delegated
  ...
  const { error } = form.getFieldState("customModelsData.BatchNorm1d", form.formState)

  const resetSection = React.useCallback(() => {
    form.resetField("customModelsData.BatchNorm1d")
    setResetKey(k => k+1)
  }, [form])
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-0">Params of BatchNorm1d</DialogTitle>
