...
import { ScaleFactorField } from "./ScaleFactor.field"
import { ModeField } from "./Mode.field" // basically interpolation mode
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className={cn("prose dark:prose-invert", "")}>
        <DialogHeader>
          <DialogTitle className="mt-0">Params of Upsample</DialogTitle>
