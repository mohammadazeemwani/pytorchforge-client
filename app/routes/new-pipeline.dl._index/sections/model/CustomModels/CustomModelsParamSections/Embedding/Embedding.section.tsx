...
import { NumEmbeddingsField } from "./NumEmbeddings.field"
import { EmbeddingDimXField } from "./EmbeddingDimX.field"
import { PaddingIdxField } from "./PaddingIdx.field"
import { MaxNormField } from "./MaxNorm.field"
import { SparseField } from "./Sparse.field"
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className={cn("prose dark:prose-invert", "")}>
        <DialogHeader>
          <DialogTitle className="mt-0">Params of Embedding</DialogTitle>
