...
export function DropoutSection({
  ...
  const { error } = form.getFieldState("customModelsData.Dropout", form.formState)

  const resetSection = React.useCallback(() => {
    form.resetField("customModelsData.Dropout")
    setResetKey(k => k+1)
  }, [form])
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-0">Params of Dropout</DialogTitle>
