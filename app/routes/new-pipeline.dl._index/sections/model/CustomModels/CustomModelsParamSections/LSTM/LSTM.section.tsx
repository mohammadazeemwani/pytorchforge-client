...
import { InputSizeField } from "./InputSize.field"
import { HiddenSizeField } from "./HiddenSize.field"
import { NumLayersField } from "./NumLayers.field"
import { BatchFirstField } from "./BatchFirst.field"
import { BidirectionalField } from "./Bidirectional.field"
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className={cn("prose dark:prose-invert", "")}>
        <DialogHeader>
          <DialogTitle className="mt-0">Params of LSTM</DialogTitle>
