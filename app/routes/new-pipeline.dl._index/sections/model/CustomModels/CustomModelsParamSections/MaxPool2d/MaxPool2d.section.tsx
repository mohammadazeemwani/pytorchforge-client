 ...
 */
export function MaxPool2dSection({
  className,
  form,
  ...delegated
  ...
  const { error } = form.getFieldState("customModelsData.MaxPool2d", form.formState)

  const resetSection = React.useCallback(() => {
    form.resetField("customModelsData.MaxPool2d")
    setResetKey(k => k+1)
  }, [form])
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-0">Params of MaxPool2d</DialogTitle>
