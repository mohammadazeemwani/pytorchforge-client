 ...
 */
export function MaxPool3dSection({
  className,
  form,
  ...delegated
  ...
  const { error } = form.getFieldState("customModelsData.MaxPool3d", form.formState)

  const resetSection = React.useCallback(() => {
    form.resetField("customModelsData.MaxPool3d")
    setResetKey(k => k+1)
  }, [form])
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-0">Params of MaxPool3d</DialogTitle>
