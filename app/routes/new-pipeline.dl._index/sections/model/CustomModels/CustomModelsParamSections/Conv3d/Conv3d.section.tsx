...
export function Conv3dSection({
  ...
  const { error } = form.getFieldState("customModelsData.Conv3d", form.formState)

  const resetSection = React.useCallback(() => {
    form.resetField("customModelsData.Conv3d")
    setResetKey(k => k+1)
  }, [form])
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-0">Params of Conv3d</DialogTitle>
