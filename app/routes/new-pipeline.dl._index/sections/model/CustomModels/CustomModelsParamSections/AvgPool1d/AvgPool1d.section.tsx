 ...
 */
export function AvgPool1dSection({
  className,
  form,
  ...delegated
  ...
  const { error } = form.getFieldState("customModelsData.AvgPool1d", form.formState)

  const resetSection = React.useCallback(() => {
    form.resetField("customModelsData.AvgPool1d")
    setResetKey(k => k+1)
  }, [form])
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-0">Params of AvgPool1d</DialogTitle>
