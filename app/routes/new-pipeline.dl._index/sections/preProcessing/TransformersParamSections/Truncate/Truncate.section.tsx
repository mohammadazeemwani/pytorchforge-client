...
import { MaxSeqLenField } from "./MaxSeqLen.field"
...
export function TruncateSection({
  ...
  const { error } = form.getFieldState("transformersData.Truncate", form.formState)

  const resetSection = React.useCallback(() => {
    form.resetField("transformersData.Truncate")
    setResetKey(k => k+1)
  }, [form])
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-0">Params of Truncate</DialogTitle>
