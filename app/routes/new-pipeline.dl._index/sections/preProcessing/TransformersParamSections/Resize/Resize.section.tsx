...
import { InterpolationField } from "./Interpolation.field"
...
export function ResizeSection({
  ...
  const { error } = form.getFieldState("transformersData.Resize", form.formState)

  const resetSection = React.useCallback(() => {
    form.resetField("transformersData.Resize")
    setResetKey(k => k+1)
  }, [form])
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className="mt-0">Params of Resize</DialogTitle>
