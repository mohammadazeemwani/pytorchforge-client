...
import { MaxLengthField } from "./MaxLength.field"
import { PadValueField } from "./PadValue.field"
import { useWatch } from "react-hook-form"

/**
 * delegated props are not applied
 */
export function PadTransformSection({
  className,
  form,
  ...delegated
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <div className="space-y-4 sm:space-y-6" key={resetKey}>
          <MaxLengthField form={form} />
          <PadValueField form={form} />
        </div>
