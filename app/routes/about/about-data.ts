...
export const members: Member[] = [
  ...
  //   name: 'Mohammad Azeem',
  //   description: [
  //     'Engineering for the World Wide Web has driven me since 2023. I strive to make the web engaging and to give users the most native experience possible. My philosophy: being on a site constitutes an <em>experience</em> for the user. Every interaction, every scroll, every click should feel intuitive and purposeful. I maintain this client for MLPipelines, ensuring seamless functionality across all touchpoints. For any improvement, feature request, or bug you encounter while surfing, <a class="link" href="https://mohammadazeem.in/contact" target="__blank">contact</a> me.',
  //     'I work as a Web Developer, though I consider myself more Engineer than Developer. In my spare time, I write <a class="link" href="https://mohammadazeem.in/posts" target="__blank">posts</a>—mostly <i>opinionated</i> pieces on Software Engineering. Learn more <a class="link" href="https://mohammadazeem.in" target="__blank">about me</a>.'
  //   ]  
  // },

  {
    ...
    name: 'Suhaib',
    description: [
      'I explored various machine learning and deep learning models, focusing on understanding their architectures, functions, and key parameters. I worked extensively with PyTorch, analyzing how its models could be effectively used in practical applications. My main goal was to integrate these models into a user-friendly UI. I designed an interface that allows users to easily interact with and visualize model outputs. This helped bridge the gap between model complexity and real-world usability.',
      'For any improvement, feature request, or bug you encounter while surfing, feel free to <a class="link" href="https://www.linkedin.com/in/suhaib-ahmad-759808223" target="__blank">reach-out</a>.'
    ]
  },
  {
