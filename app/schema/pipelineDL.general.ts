...
export const Interpolation = z.enum(['nearest', 'nearest_exact', 'bilinear', 'bicubic']);
...
export const pipelineDL_CustomModels_Schema = z.object({
  Linear: z.object({
...
export const pipelineDL_Losses_Schema = z.object({
...
export const pipelineDL_Optimizers_Schema = z.object({
  Adam: z.object({
 ...
 * */
export const pipelineDL_Monitoring_Schema = z.enum([
  'use_tensorboard',
  'use_wandb', 
  'use_mlflow',
  'resource_alerts',
...
export const pipelineDL_Metrics_Schema = z.object({
  Accuracy: z.object({
    task: TaskSchema,
...
export const pipelineDL_EarlyStopping_Schema = z.object({
  patience: z.number(),
...
export const pipelineDL_LRSchedular_Schema = z.object({
