...
export const textTransformersSchema = {
  RegexTokenizer: z.object({
  ...
  SentencePieceTokenizer: z.object({
    /** UI-ELEMENT:  FILE PICKER */
    sp_model_path: z.string().optional(),
  }).optional(),
  VocabTransform: z.object({
